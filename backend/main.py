...
def ai_signal(
    ...
    try:
        ...
        return {
            ...
            "entry_price": (llm_result.get("entry_price") or signal.entry_price) if llm_result else signal.entry_price,
            "stop_loss": (llm_result.get("stop_loss") or signal.stop_loss) if llm_result else signal.stop_loss,
            "take_profit": (llm_result.get("take_profit") or signal.take_profit) if llm_result else signal.take_profit,
